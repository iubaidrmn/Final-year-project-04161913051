...
class StatsRecords extends Component {
  ...
  generateReport = () => {
    const { selectedOption, selectedTournament, selectedChartType } = this.state;
    ...
    doc.setFontSize(18);
    doc.text(selectedOption === 'topPlayers' ? 'Top Players' : 'Top Bowlers', 15, 45);
  ...
  renderTopPlayers = () => {
    ...
    const topPlayersData = {
      tournament1: [
        { position: 1, name: 'Player 1', runs: 1000, rating: 9.5, strikeRate: 120.5 },
        { position: 2, name: 'Player 2', runs: 900, rating: 9.2, strikeRate: 110.2 },
        // Add more players for tournament1...
      ],
      tournament2: [
        { position: 1, name: 'Player 3', runs: 800, rating: 9.0, strikeRate: 105.3 },
        { position: 2, name: 'Player 4', runs: 750, rating: 8.8, strikeRate: 98.6 },
          ...
          >
            <thead>
              <tr>
                ...
                <th style={{ padding: '8px', border: '1px solid #ccc' }}>Rating</th>
                <th style={{ padding: '8px', border: '1px solid #ccc' }}>Strike Rate</th>
              </tr>
            </thead>
            <tbody>
              {topPlayers.map((player, index) => (
                <tr key={index}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #ccc' }}>{player.runs}</td>
                  <td style={{ padding: '8px', border: '1px solid #ccc' }}>{player.rating}</td>
                  <td style={{ padding: '8px', border: '1px solid #ccc' }}>{player.strikeRate}</td>
                </tr>
              ))}
            </tbody>
          </table>
          {this.state.showCharts && (
            <div style={{ marginLeft: '20px', width: '400px', height: '400px' }}>
  ...
  renderTopBowlers = () => {
    ...
    const topBowlersData = {
      tournament1: [
        { position: 1, name: 'Bowler 1', wickets: 50, rating: 9.0, average: 20.5 },
        { position: 2, name: 'Bowler 2', wickets: 45, rating: 8.8, average: 22.3 },
        // Add more bowlers for tournament1...
      ],
      tournament2: [
        { position: 1, name: 'Bowler 3', wickets: 40, rating: 8.5, average: 23.1 },
        { position: 2, name: 'Bowler 4', wickets: 35, rating: 8.2, average: 25.8 },
          ...
          >
            <thead>
              <tr>
                <th style={{ padding: '8px', border: '1px solid #ccc' }}>Position</th>
                <th style={{ padding: '8px', border: '1px solid #ccc' }}>Name</th>
                <th style={{ padding: '8px', border: '1px solid #ccc' }}>Wickets</th>
                <th style={{ padding: '8px', border: '1px solid #ccc' }}>Rating</th>
            ...
            <tbody>
              {topBowlers.map((bowler, index) => (
                <tr key={index}>
                  <td style={{ padding: '8px', border: '1px solid #ccc' }}>{bowler.position}</td>
                  <td style={{ padding: '8px', border: '1px solid #ccc' }}>{bowler.name}</td>
                  <td style={{ padding: '8px', border: '1px solid #ccc' }}>{bowler.wickets}</td>
                  <td style={{ padding: '8px', border: '1px solid #ccc' }}>{bowler.rating}</td>
                  <td style={{ padding: '8px', border: '1px solid #ccc' }}>{bowler.average}</td>
                </tr>
              ))}
            </tbody>
          </table>
  ...
  render() {
    const { selectedOption, selectedTournament, selectedChartType, showCharts } = this.state;
              ...
              <div style={{ marginTop: '10px' }}>
                <button
                  style={{
                    ...
                    marginRight: '10px',
                    fontSize: '16px',
                    backgroundColor: selectedOption === 'topPlayers' ? '#ccc' : '#f0f0f0',
                    border: 'none',
                    borderRadius: '4px',
                    cursor: 'pointer',
                    margin: '0 5px',
                ...
                <button
                  style={{
                    ...
                    marginRight: '10px',
                    fontSize: '16px',
                    backgroundColor: selectedOption === 'topBowlers' ? '#ccc' : '#f0f0f0',
                    border: 'none',
                    borderRadius: '4px',
                    cursor: 'pointer',
                    margin: '0 5px',
